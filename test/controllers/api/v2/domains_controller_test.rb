...
class Api::V2::DomainsControllerTest < ActionController::TestCase
  ...
  context 'user with resource permissions scoped to single org and loc' do
    def setup
      ...
      @user = FactoryGirl.create(:user, :organization_ids => [@org1.id], :location_ids => [@loc1.id], :roles => [ @role ])

      @domain1 = FactoryGirl.create(:domain, :organization_ids => [@org1.id], :location_ids => [@loc1.id])
      @domain2 = FactoryGirl.create(:domain, :organization_ids => [@org2.id], :location_ids => [@loc1.id])
    end
  ...
  context 'user with resource permissions scoped to 2 organizations' do
    def setup
      ...
      @loc1 = FactoryGirl.create(:location)
      @role = FactoryGirl.build(:role, :organization_ids => [@org1.id, @org2.id], :location_ids => [@loc1.id])
      ...
      @user = FactoryGirl.create(:user, :organization_ids => [@org1.id, @org2.id], :location_ids => [@loc1.id], :roles => [@role])

      @domain1 = FactoryGirl.create(:domain, :organization_ids => [@org1.id], :location_ids => [@loc1.id])
      @domain2 = FactoryGirl.create(:domain, :organization_ids => [@org2.id], :location_ids => [@loc1.id])
      @domain3 = FactoryGirl.create(:domain, :organization_ids => [@org3.id], :location_ids => [@loc1.id])
    end
